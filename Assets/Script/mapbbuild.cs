...
public class mapbbuild : MonoBehaviour
{
    public GameObject o1, o2, o3, o4, o5, o6, o7, o8, o9, o10, o11, o12, o13, o14, o15, o16, o17, o18, o19;
    public GameObject start,fire;
    // Start is called before the first frame update
    void Start()
    {
        if (PlayerPrefs.GetInt("emerg2fin") != 1)
        {
            if (PlayerPrefs.GetInt("src") != 1)
            {
                Invoke("story", 2f);
                start.GetComponent<mapbff>().enabled = true;
                fire.SetActive(true);
                calculate.money -= 600;
            }
            else if (PlayerPrefs.GetInt("src") == 1)
            {
                Invoke("story", 2f);
                start.GetComponent<mapbff2>().enabled = true;
            }
        }
        else
        {
